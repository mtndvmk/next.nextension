...
namespace Nextension
{
    ...
    {
        internal static readonly Action<Exception> LogException = NDebug.LogException;
        ...
        {
            (nAction ??= new NAction()).add(callback);
            return nAction;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NAction operator -(NAction nAction, Action callback)
    ...
    public class NAction<T>
    {
        ...
        {
            tryInvoke(result, NAction.LogException);
        }
        ...
        {
            (nAction ??= new NAction<T>()).add(callback);
            return nAction;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NAction<T> operator -(NAction<T> nAction, Action<T> callback)
    ...
    {
        private readonly NAction _nAction = new NAction();
        ...
        {
            (nCallback ??= new NCallback()).add(callback);
            return nCallback;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NCallback operator -(NCallback nCallback, Action callback)
    ...
    {
        private readonly NAction<T> _nAction = new NAction<T>();
        public int Count => _nAction.Count;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void add(Action<T> callback)
        {
        ...
        {
            (nCallback ??= new NCallback<T>()).add(callback);
            return nCallback;
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static NCallback<T> operator -(NCallback<T> nCallback, Action<T> callback)
