...
namespace Nextension
{
    ...
    public abstract class AbsBList<TValue, TCompareKey> : IBList, IList<TValue>, IEnumerable<TValue>, IReadOnlyCollection<TValue>, IReadOnlyList<TValue>
    {
        ...
        protected bool equalValue(TValue item1, TValue item2) => item1.equals(item2);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        private int exeCompareValue(TValue a, TValue b) => exeCompareKey(getCompareKeyFromValue(a), getCompareKeyFromValue(b));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int FindIndex(Predicate<TValue> predicate) => _list.FindIndex(predicate);


        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Add(TValue item) => _list.Add(item);
        /// <summary>
        /// return true if item added, otherwise return false
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Insert(int index, TValue item) => _list.Insert(index, item);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AddRange(ICollection<TValue> collection) => _list.AddRange(collection);
        ...
        private Comparison<TValue> _valueComparsion;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Sort()
        {
            _valueComparsion ??= exeCompareValue;
            _list.Sort(_valueComparsion);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public List<TValue> ToList() => new List<TValue>(_list);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TValue[] ToArray() => _list.ToArray();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Span<TValue> AsSpan() => _list.AsSpan();
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        public List<TValue>.Enumerator GetEnumerator() => _list.GetEnumerator();

        IEnumerator IEnumerable.GetEnumerator() => _list.GetEnumerator();

        IEnumerator<TValue> IEnumerable<TValue>.GetEnumerator() => _list.GetEnumerator();

        public TValue takeAndRemoveLast() => _list.takeAndRemoveLast();
        #endregion
    }
    /// <summary>
    /// 
