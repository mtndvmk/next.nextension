...
{
    [BurstCompile]
    public static class BurstEaseUtils
    {
        [BurstCompile]
        public static void ease(in float a, in float b, in float t, in EaseType type, out float result)
        {
            switch (type)
            {
                default:
        ...
        [BurstCompile]
        public static void ease(in float2 a, in float2 b, in float t, in EaseType type, out float2 result)
        {
            ease(a.x, b.x, t, type, out result.x);
            ease(a.y, b.y, t, type, out result.y);
        }
        [BurstCompile]
        public static void ease(in float3 a, in float3 b, in float t, in EaseType type, out float3 result)
        {
            ease(a.x, b.x, t, type, out result.x);
            ease(a.y, b.y, t, type, out result.y);
            ease(a.z, b.z, t, type, out result.z);
        }
        [BurstCompile]
        public static void ease(in float4 a, in float4 b, in float t, in EaseType type, out float4 result)
        {
            ...
            ease(a.y, b.y, t, type, out result.y);
            ease(a.z, b.z, t, type, out result.z);
            ease(a.w, b.w, t, type, out result.w);
        }
        [BurstCompile]
        ...
        [BurstCompile]
        public static void sineIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void sineOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void sineInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quadIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quadOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quadInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void cubicIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void cubicOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void cubicInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quartIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quartOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quartInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quintIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quintOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void quintInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void expoIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void expoOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void expoInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void circIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void circOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void circInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void backIn(in float a, in float b, in float t, out float result)
        {
            //var c1 = 1.70158f;
        ...
        [BurstCompile]
        public static void backOut(in float a, in float b, in float t, out float result)
        {
            //var c1 = 1.70158f;
            //var c3 = c1 + 1;// = 2.70158f
            if (t >= 1)
        ...
        [BurstCompile]
        public static void backInOut(in float a, in float b, in float t, out float result)
        {
            //var c1 = 1.70158f;
        ...
        [BurstCompile]
        public static void elasticIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void elasticOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void elasticInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void bounceOut(in float a, in float b, in float inT, out float result)
        {
            var t = inT;
            if (t >= 1)
            {
        ...
        [BurstCompile]
        public static void bounceIn(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
        ...
        [BurstCompile]
        public static void bounceInOut(in float a, in float b, in float t, out float result)
        {
            if (t >= 1)
            {
                result = b;
