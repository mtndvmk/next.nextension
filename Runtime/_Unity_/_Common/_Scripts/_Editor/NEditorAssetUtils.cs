...
namespace Nextension
{
    public static class NEditorAssetUtils
    {
        ...
        private static HashSet<Object> _needSaves = new HashSet<Object>();
        ...
        public static (string path, ScriptableObject scriptableObject)[] loadAll(string directory)
        {
            ...
            List<(string path, ScriptableObject scriptableObject)> result = new List<(string path, ScriptableObject scriptableObject)>();
        ...
        public static ScriptableObject createInMainResources(System.Type type, string fileName)
        {
            ...
            else
            {
                ...
                NDebug.Log($"Create asset at `{filePath}`", scriptable);
            }
            return scriptable;
        }
