...
namespace Nextension
{
    ...
    public class NScheduler<TSchedulable> where TSchedulable : NOperation, ISchedulable
    {
        ...
        public NBList<TSchedulable, int> Pending => _pending ??= new NBList<TSchedulable, int>(item => item.Priority);
        public List<TSchedulable> Executing => _executing ??= new List<TSchedulable>();
