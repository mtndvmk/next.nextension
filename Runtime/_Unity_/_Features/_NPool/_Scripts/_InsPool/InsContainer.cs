...
namespace Nextension
{
        ...
        where T : Object
    {
        ...
        {
            _instanceList = new List<T>(_startupInstanceCount);
        ...
        public ReadOnlySpan<T> getInstances(int count, int fromIndex = 0)
        {
        ...
        public ReadOnlySpan<T> getNext(int count)
        {
        ...
        public ReadOnlySpan<T> asActivatedItemSpan()
        {
            requireCall();
            return _instanceList.asSpan()[.._activatedCount];
        }
        public ReadOnlySpan<T> asAllItemSpan()
        {
            requireCall();
