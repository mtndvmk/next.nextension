...
namespace Nextension
{
    internal class NWaitableResultGetter
    {
        ...
        public NWaitableState getCurrentState()
        {
            try
            {
                switch (funcType)
                {
                    ...
                    case FuncType.AsyncOperation:
                        {
                            return __getResult_AsyncOperation(asyncOperation);
                        }
                    default:
                        {
        ...
        private static NWaitableState __getResult_AsyncOperation(UnityEngine.AsyncOperation asyncOperation)
        {
            return asyncOperation.isDone ? NWaitableState.Completed : NWaitableState.None;
        }
        ...
        {
            this.funcType = FuncType.AsyncOperation;
            this.asyncOperation = waitable.asyncOperation;
        }
