...
namespace Nextension.Tween
{
    public static class NTween
    {
        ...
        public static NRunnableTweener moveTo(Transform target, Transform destination, float duration, bool isLocalSpace = true)
        {
            NRunnableTweener tweener;
            if (isLocalSpace)
            {
        ...
        public static NRunnableTweener rotateTo(Transform target, Transform destination, float duration, bool isLocalSpace = true)
        {
            NRunnableTweener tweener;
            if (isLocalSpace)
            {
        ...
        public static NRunnableTweener scaleTo(Transform target, Transform destination, float duration, bool uniformScale = false)
        {
            NRunnableTweener tweener;
            if (uniformScale)
            {
        ...
        public static NRunnableTweener punchPosition(Transform target, Transform punchDestination, float duration, bool isLocalSpace = true)
        {
            NRunnableTweener tweener;
            if (isLocalSpace)
            {
        ...
        public static NRunnableTweener punchRotation(Transform target, Transform punchDestination, float duration, bool isLocalSpace = true)
        {
            NRunnableTweener tweener;
            if (isLocalSpace)
            {
        ...
        public static NRunnableTweener punchScale(Transform target, Transform punchDestination, float duration, bool uniformScale = false)
        {
            NRunnableTweener tweener;
            if (uniformScale)
            {
        ...
        public static NRunnableTweener shakePosition(Transform target, Transform destination, float distance, float duration, bool isLocalSpace = true)
        {
            NRunnableTweener tweener;
            if (isLocalSpace)
            {
        ...
        public static NRunnableTweener shakeRotation(Transform target, Transform destination, float distance, float duration, bool isLocalSpace = true)
        {
            NRunnableTweener tweener;
            if (isLocalSpace)
            {
        ...
        public static NRunnableTweener shakeScale(Transform target, Transform destination, float distance, float duration, bool uniformScale = true)
        {
            NRunnableTweener tweener;
            if (uniformScale)
            {
