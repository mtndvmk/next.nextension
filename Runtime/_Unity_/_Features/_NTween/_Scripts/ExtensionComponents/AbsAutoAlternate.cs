...
namespace Nextension.Tween
{
    public abstract class AbsAutoAlternate : MonoBehaviour
    {
        ...
        [ContextMenu("Capture Offset Value")]
        protected void captureOffsetValue()
        {
            onCaptureOffsetValue();
        }
        [ContextMenu("Capture From Value")]
        protected void captureFromValue()
        {
            onCaptureFromValue();
        }
        [ContextMenu("Capture To Value")]
        protected void captureToValue()
        {
            onCaptureToValue();
        }

        protected virtual void onCaptureOffsetValue()
        {
        }
        protected virtual void onCaptureFromValue()
        {
        }
        protected virtual void onCaptureToValue()
        {
        }
    ...
    public abstract class AbsAutoAlternate<T> : AbsAutoAlternate
    {
        ...
        [SerializeField, NShowIf(nameof(EnableOffset))] protected bool _updateOffsetOnEnable = false;
        [SerializeField, NConstrainable, NShowIf(nameof(_useOffset))] protected T _offset;
        ...
        protected virtual void OnEnable()
        {
            ...
            {
                case ValState.From:
                    setValueWithoutOffset(_fromValue);
                    break;
                case ValState.To:
                    setValueWithoutOffset(_toValue);
                    break;
            }
            if (_isStartOnEnable)
            {
        ...
        protected virtual void setValueWithoutOffset(T value)
        {
            setValue(value);
        }
