...
namespace Nextension.Tween
{
    ...
    {
        private readonly SimpleDictionary<long, HashSet<NTweener>> _controlledTweeners = new SimpleDictionary<long, HashSet<NTweener>>();
        private readonly SimpleDictionary<long, Object> _objectKeys = new SimpleDictionary<long, Object>();
        ...
        public void addTweener(NTweener tweener)
        {
            ...
            {
                hashset = new HashSet<NTweener>() { tweener };
