...
namespace Nextension
{
    ...
    public interface IInsPool<T> : IInsPool, IComponentInstantiator<T> where T : Object
    {
        ...
        T get(Vector3 position, Transform parent = null, bool worldPositionStays = true);
        T getAndRelease(IWaitable releaseWaitable, Transform parent = null, bool worldPositionStays = true);
        T getAndRelease(IWaitable releaseWaitable, Vector3 position, Transform parent = null, bool worldPositionStays = true);
        T getAndDelayRelease(float delaySeconds, Transform parent = null, bool worldPositionStays = true);
        T getAndDelayRelease(float delaySeconds, Vector3 position, Transform parent = null, bool worldPositionStays = true);
    ...
    public abstract class AbsInsPool<T> : IInsPool<T> where T : Object
    {
        ...
        public abstract T get(Vector3 position, Transform parent = null, bool worldPositionStays = true);
        ...
        public ComponentInstantiator<T2> getComponentInstantiator<T2>() where T2 : Object
        {
        ...
        public T getAndRelease(IWaitable waitable, Vector3 position, Transform parent = null, bool worldPositionStays = true)
        {
            T item = get(position, parent, worldPositionStays);
            waitAndRelease(waitable, item);
            return item;
        }
        ...
        public T getAndDelayRelease(float delaySeconds, Vector3 position, Transform parent = null, bool worldPositionStays = true)
        {
            T item = get(position, parent, worldPositionStays);
            waitAndRelease(new NWaitSecond(delaySeconds), item);
            return item;
