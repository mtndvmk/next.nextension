...
namespace Nextension
{
    public class OriginInstance : MonoBehaviour, IInsPoolable
    {
        ...
        private bool _isDestroyedByPool;
        ...
        void IInsPoolable.onDestroy(bool isRoot)
        {
            _isDestroyedByPool = true;
        }
...
#endif
            if (IsInPool && !_isDestroyedByPool)
            {
                Debug.LogWarning("Object not released to pool before OnDisable", gameObject);
            }
        }
